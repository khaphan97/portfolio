...
export function Hero() {
  return (
    <section id="top" className="relative overflow-hidden">
      ...
      <Stagger className="relative mx-auto max-w-5xl px-5 pt-36 pb-20 sm:pt-44 sm:pb-28">
        <StaggerItem>
        ...
        <StaggerItem className="mt-14">
          <dl className="grid grid-cols-3 gap-6 border-t border-line pt-8 sm:max-w-lg">
            {stats.map((s) => (
              <div key={s.label}>
